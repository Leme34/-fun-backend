<template>
  <aside class="site-sidebar" :class="'site-sidebar--' + sidebarLayoutSkin">
    <div class="site-sidebar__inner">
      ...
      >
        <el-menu-item index="聚合分析" @click="navigate({ name: 'home' })">
          <icon-svg name="shouye" class="site-sidebar__menu-icon" />
          <span slot="title">聚合分析</span>
        </el-menu-item>
        <el-menu-item
          index="用户雷达"
          @click="navigate({ name: 'user-filter' })"
        >
          <icon-svg name="tubiao" class="site-sidebar__menu-icon" />
          <span slot="title">用户雷达</span>
        </el-menu-item>
        ...
        <!-- <el-submenu index="demo">
          ...
          <el-menu-item
            index="demo-echarts"
            @click="navigate({ name: 'demo-echarts' })"
          >
            <icon-svg name="tubiao" class="site-sidebar__menu-icon" />
